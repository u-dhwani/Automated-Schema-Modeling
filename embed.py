...
db = client["e-comm"]  # Replace with your MongoDB database name
collection = db["doc1"]  # Replace with your MongoDB collection name

# Specify the path to your CSV file
df = pd.read_csv("input_files/ecommerce-cardinality.csv")
# print(df.head())
...
for index, row in df.iterrows():
    ...
    if column1_value == 1 and column2_value > 500: # one-to-many as well as one-to-squillion
        ...
        # print("embed")
        # entity_attributes[entity1].append({entity2: "array"})
